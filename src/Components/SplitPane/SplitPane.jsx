...
class SplitPane extends React.Component {
  constructor(props) {
    ...
    this.state = {
      active: false,
      resized: false,
      pane1Size: primary === 'first' ? initialSize : `calc(100% - ${initialSize}${isNaN(initialSize)?'':'px'})`,
      pane2Size: primary === 'second' ? initialSize : `calc(100% - ${initialSize}${isNaN(initialSize)?'':'px'})`,
      ...
      if (ref) {
        ...
        if (node.getBoundingClientRect) {
          ...
          this.setState({
            ...
            [isPrimaryFirst ? 'pane2Size' : 'pane1Size']: `calc(100% - ${newSize}${isNaN(newSize)?'':'px'})`
          });
        }
      }
    }
  ...
  static getSizeUpdate(props, state) {
    ...
    newState[isPanel1Primary ? 'pane2Size' : 'pane1Size'] = `calc(100% - ${newSize}${isNaN(newSize)?'':'px'})`;
  ...
  render() {
    ...
    console.log(pane1Size, pane2Size)
